...
<style>
body {
  font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; /* 更換為較現代的字體 */
  margin: 0;
  background-color: #f8f8f6; /* 莫蘭迪米白色背景 */
  color: #4a4a4a; /* 深灰色文字 */
}
...
.brand-container {
  ...
  color: #4a4a4a; /* 主要文字顏色 */
  border-left: 5px solid; /* 左側邊框作為強調色 */
}
...
.brand-title {
  font-size: 1.6em;
  font-weight: 600; /* 字重稍加粗 */
  margin-bottom: 12px;
  color: inherit; /* 繼承容器設定的文字顏色 */
}
...
<div class="container">
  ...
  <div class="brand-container color-pale-terracotta"> <!-- 焦糖楓 -->
  ...
  <div class="brand-container color-dusty-blue"> <!-- 清心福全 -->
  ...
  <div class="brand-container color-muted-rose"> <!-- 飛亞旅行社 / MyTaiwanTour / 匠生活 -->
  ...
  <div class="brand-container color-sage-green"> <!-- 勤億蛋品 -->
   ...
   <div class="brand-container color-stone-grey"> <!-- 亞家生技 -->
  ...
  <div class="brand-container color-light-beige"> <!-- 偉喬生醫 -->
  ...
  <div class="brand-container color-soft-lavender"> <!-- 凱莉小姐 Lady Kelly -->
  ...
  <div class="brand-container color-warm-sand"> <!-- 愛雅辣呦 -->
  ...
  <div class="brand-container color-ash-grey"> <!-- 臭味滾 -->
  ...
  <div class="brand-container color-powder-blue"> <!-- 倍力寵物健康食品 -->
  ...
  <div class="brand-container color-peach-puff"> <!-- 貪貪生態貓食 -->
  ...
  <div class="brand-container color-misty-green"> <!-- 尾巴丘毛孩選物 -->
  ...
  <div class="brand-container color-light-taupe"> <!-- 旺萊山 -->
  ...
  <div class="brand-container color-ivory"> <!-- 十藝生技 -->
  ...
  <div class="brand-container color-sky-grey"> <!-- 綠豐興業 -->
